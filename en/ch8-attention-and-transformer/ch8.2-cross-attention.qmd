...
x = torch.randn(3, 5, 4)  # query sequence, length = 5
y = torch.randn(3, 8, 6)  # key/value sequence, length = 8
cross_attn = CrossAttention(attn_dim=4, q_dim=4, k_dim=6, v_dim=6)
...
<figure class="figure" style="text-align: center;">
  <img src="figures/ch8.2-sdpa.png" alt="Figure 1: SDPA computation diagram" style="height: 250px;">
