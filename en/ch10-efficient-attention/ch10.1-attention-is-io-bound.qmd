...
This is exactly the starting point of flash attention. In the next section, we will see that it does not approximate attention, but instead makes the execution process of attention access HBM as little as possible through better blocking and better IO organization.
