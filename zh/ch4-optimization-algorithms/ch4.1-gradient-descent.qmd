...
history = dopt.run_sgd(loss_fn, theta, lr=0.4, steps=40)
...
```{python}
theta = torch.tensor([-5.0, 2.0])
history_no_decay = dopt.run_sgd(loss_fn, theta, lr=0.4, steps=40)
history_with_decay = dopt.run_sgd_with_weight_decay(
    loss_fn, theta, lr=0.4, weight_decay=0.2, steps=40
)
